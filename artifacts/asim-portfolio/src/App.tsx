...
const themes = {
  light: {
    ...
    devBtn:      'border-purple-400/60 bg-gradient-to-r from-purple-500/15 via-indigo-500/10 to-pink-500/10 text-purple-700 hover:from-purple-500/30 hover:via-indigo-500/20 hover:to-pink-500/20 hover:border-purple-500/80 hover:text-purple-800 shadow-sm hover:shadow-purple-400/30',
  ...
  dark: {
    ...
    devBtn:      'border-purple-500/50 bg-gradient-to-r from-purple-600/20 via-indigo-600/15 to-pink-600/10 text-purple-300 hover:from-purple-600/35 hover:via-indigo-600/25 hover:to-pink-600/20 hover:border-purple-400/80 hover:text-purple-200 shadow-sm hover:shadow-purple-500/30',
